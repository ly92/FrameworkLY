...
@property (nonatomic, readwrite) LYTabBar *tabBar;
...
- (void)setTabBarHidden:(BOOL)hidden animated:(BOOL)animated {
    ...
    __weak LYTabBarController *weakSelf = self;
...
#pragma mark - UIViewController+LYTabBarControllerItem
...
- (void)LY_setTabBarItem:(LYTabBarItem *)tabBarItem {
    ...
    LYTabBar *tabBar = [tabBarController tabBar];
    NSInteger index = [tabBarController indexForViewController:self];
