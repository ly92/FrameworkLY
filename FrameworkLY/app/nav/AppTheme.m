...
+ (void)setupAppearance
{
    ...
    [[UINavigationBar appearance] setBackgroundImage:[UIImage imageWithColor:NAV_COLOR]
                                       forBarMetrics:UIBarMetricsDefault];
    
    
    NSMutableDictionary * attribute = [NSMutableDictionary dictionaryWithObject:[UIColor whiteColor] forKey:NSForegroundColorAttributeName];
...
+ (UIColor *)mainColor
{
    return [UIColor colorWithRGB:0x27A2F0];
}

+ (UIColor *)titleColor
{
    return [UIColor colorWithRGB:0x333B46];
}

+ (UIColor *)subTitleColor
{
    return [UIColor colorWithRGB:0xBFC7CC];
}

//背景颜色
+ (UIColor *)bgColor
{
    return [UIColor colorWithRGB:0xF2F3F4];
}

+ (UIColor *)lineColor
{
    return [UIColor colorWithRGB:0xE6E9EA];
}
...
+ (NSMutableAttributedString *)timelineNameButtonwithName:(NSString *)name font:(CGFloat)font
{
    ...
    NSMutableAttributedString * nickName = [[NSMutableAttributedString alloc] initWithString:[NSString stringWithFormat:@"%@", name] attributes:@{                                                                                        NSFontAttributeName : fontName,                                                                                                                                                                             NSForegroundColorAttributeName : [UIColor colorWithRGB:0x576B95],
                                                                                                                                                                                                                                          }];
    return nickName;
}
                                                ...
                                                ranges:(NSArray *)ranges
{
    ...
    dispatch_once(&onceToken, ^{
        ...
        s1 = @{
               ...
               NSForegroundColorAttributeName : [UIColor colorWithRGB:0x576B95],
